export const en = {
  ...
  admin: {
    ...
    pages: {
      ...
      connectorKeysDesc:
        'API keys your connectors use to reach this instance. One per provider, shown once.',
    ...
    connectorKeys: {
      ...
      provider: 'Provider',
      providerHint:
        "The connector's provider name (e.g. rss). Free text — a key can exist before the connector has ever run.",
      name: 'Label',
      namePlaceholder: 'prod rss key',
      create: 'Create',
      creating: 'Creating…',
      createFailed: 'Could not create the key.',
      shownOnce: "Copy this now — it is shown only once. Put it in the connector's STAYUP_API_KEY.",
      copy: 'Copy',
      copied: 'Copied',
      done: 'Done',
      key: 'Key',
      ...
      revoke: 'Revoke',
      revoked: 'Revoked',
      revokeConfirm: 'Revoke the key “{name}”? The connector using it will stop working.',
      none: 'No keys yet',
    },
    dataSources: {
